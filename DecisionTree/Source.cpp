...
//Sergio Bank
// 342689155
/*The program builds a decision tree , giving the ability to add questions , answers,solutions,
printing paths to questions/solutions , printing in a hierachial way the whole tree, erasing questions,answers
*/
#include <iostream>
#include <list>
#include <string>
